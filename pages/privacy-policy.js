...
export default function PrivacyPolicy() {
  ...
  // 🔹 Function to fetch markdown data dynamically
...
For privacy concerns, email us at **support@example.com**.
  ...
  return (
    <main>
      <Head>
        <meta charSet="UTF-8" />
        <title>{"This is home privacy policy title "}</title>
        <meta name="description" content={"This is privacy policy page description example and loream words can do that did you know."} />
      ...
      <div className="py-20">
        <Container className={"justify-center flex  items-center   "} >
          <div className="w-[800px]">
            ...
            [&_h1]:text-3xl [&_h1]:font-bold [&_h1]:text-[#002B5B] [&_h1]:mb-4
